...
SatO2 = 0.75;
C_HbT = 87.1*1e-6;
C_HbO2_GM = SatO2*C_HbT;
C_Hb_GM = (1-SatO2)*C_HbT;
C_CCO = 5.3*1e-6;
F_Water = 0.73;
F_Fat = 0.1;
...
if compute_Static==1
    ...
    temp(5,:) = C_oxCCO_cap;
    temp(6,:) = C_redCCO_cap;
    writematrix(temp,strcat(path,'activated_capillaries.txt'),'Delimiter',' ');
    ...
    temp(5,:) = C_oxCCO_cap;
    temp(6,:) = C_redCCO_cap;
    writematrix(temp,strcat(path,'capillaries.txt'),'Delimiter',' ');
    ...
    temp(5,:) = C_CCO;
    temp(6,:) = 0;
    writematrix(temp,strcat(path,'activated_grey_matter.txt'),'Delimiter',' ');
    ...
    temp(5,:) = C_CCO;
    temp(6,:) = 0;
    writematrix(temp,strcat(path,'grey_matter.txt'),'Delimiter',' ');
    ...
    temp(5,:) = C_oxCCO_LBV;
    temp(6,:) = C_redCCO_LBV;
    writematrix(temp,strcat(path,'activated_large_blood_vessels.txt'),'Delimiter',' ');
    ...
    temp(5,:) = C_oxCCO_LBV;
    temp(6,:) = C_redCCO_LBV;
    writematrix(temp,strcat(path,'large_blood_vessels.txt'),'Delimiter',' ');
    ...
    C_oxCCO_GM_non_act  = C_CCO + Delta_oxCCO_response_non_activated_area;
    C_redCCO_GM_non_act = zeros(size(C_Hb_GM_non_act));
    prop_H2O_GM_non_act = F_Water*ones(size(C_Hb_GM_non_act));
    prop_Fat_GM_non_act = F_Fat*ones(size(C_Hb_GM_non_act));
    ...
    C_oxCCO_GM_act      = C_CCO + Delta_oxCCO_response_activated_area;
