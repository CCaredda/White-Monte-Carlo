...
The results of this segmentation step are written in the folder \char`\"{}images\char`\"{}.\hypertarget{index_sec_simu}{}\doxysubsection{2) Simulations}\label{index_sec_simu}
