function process_simulations(Lambdas,run_in_cluster,in_img_path,out_path)
    %%-----------------------------------------------------------------
    ...
    [img,resolution_xyz] = Load_img_segmentation(in_img_path);
    ...
    % save output
    writematrix(output_det.nscat,strcat(out_path,'nscat_',num2str(Lambdas),'.txt'));
    writematrix(output_det.ppath,strcat(out_path,'ppath_',num2str(Lambdas),'.txt'));
    writematrix(output_det.p,strcat(out_path,'p_',num2str(Lambdas),'.txt'));
    writematrix(output_det.v,strcat(out_path,'v_',num2str(Lambdas),'.txt'));
    writematrix(output_det.prop,strcat(out_path,'prop_',num2str(Lambdas),'.txt'));
